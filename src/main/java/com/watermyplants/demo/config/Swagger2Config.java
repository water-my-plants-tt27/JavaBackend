package com.watermyplants.demo.config;
...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors
                .basePackage("com.watermyplants.demo"))
    ...
    {
        return new ApiInfoBuilder().title("Water My Plants Model Example")
            .description("Water My Plants Model Example")
            .contact(new Contact("Nate Grandelis",
                "http://www.google.com",
